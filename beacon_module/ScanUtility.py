...
def parse_events(sock, loop_count=100):
    ...
    for i in range(0, loop_count):
        ...
        if dataString[38:46] == '4c000215':
            ...
            """
            type = "iBeacon"
            uuid = dataString[46:54] + "-" + dataString[54:58] + "-" + dataString[
                                                                       58:62] + "-" + dataString[
                                                                                      62:66] + "-" + dataString[
                                                                                                     66:78]
            ...
            fixStructure = iter("".join(
                reversed([scrambledAddress[i:i + 2] for i in range(0, len(scrambledAddress), 2)])))
            ...
            resultsArray = [
                {"type": type, "uuid": uuid, "major": majorVal, "minor": minorVal, "rssi": rssi,
